...
class SGRecall(SceneGraphEvaluation):
    ...
    def register_container(self, mode):
        self.result_dict[mode + '_recall'] = {1: [], 3: [], 5: [], 10: [], 20: [], 50: [], 100: []}
...
class SGNGZeroShotRecall(SceneGraphEvaluation):
    ...
    def register_container(self, mode):
        self.result_dict[mode + '_ng_zeroshot_recall'] = {1: [], 3: [], 5: [], 10: [], 20: [], 50: [], 100: []}
...
class SGMeanRecall(SceneGraphEvaluation):
    ...
    def register_container(self, mode):
        ...
        self.result_dict[mode + '_mean_recall_collect'] = {1: [[] for i in range(self.num_rel)], 3: [[] for i in range(self.num_rel)], 5: [[] for i in range(self.num_rel)], 10: [[] for i in range(self.num_rel)], 20: [[] for i in range(self.num_rel)], 50: [[] for i in range(self.num_rel)], 100: [[] for i in range(self.num_rel)]}
...
class SGNGMeanRecall(SceneGraphEvaluation):
    ...
    def register_container(self, mode):
        ...
        self.result_dict[mode + '_ng_mean_recall_collect'] = {1: [[] for i in range(self.num_rel)], 3: [[] for i in range(self.num_rel)], 5: [[] for i in range(self.num_rel)], 10: [[] for i in range(self.num_rel)], 20: [[] for i in range(self.num_rel)], 50: [[] for i in range(self.num_rel)], 100: [[] for i in range(self.num_rel)]}
...
class SGAccumulateRecall(SceneGraphEvaluation):
    ...
    def register_container(self, mode):
        self.result_dict[mode + '_accumulate_recall'] = {1: 0.0, 3: 0.0, 5: 0.0, 10: 0.0, 20: 0.0, 50: 0.0, 100: 0.0}
